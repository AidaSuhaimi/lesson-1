    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <header class="w3-container" style="padding-top:22px">
                <h5><b><i class="fa fa-dashboard"></i> View Position </b></h5>
            </header>

            <div class="container">
                
                <p><button onclick="location.href='AddPosition'" class="w3-button w3-red w3-round-XLarge"> + ADD RECORD </button>
                </p>
                
                <form method="POST" action="ViewPositionController" style="border:5px solid #ccc">
                    ...
                    <table class="w3-table-all" align="center">
                        ...
                        <tr>
                            ...
                            <th><b>EDIT POSITION</b></th>
                            <th><b>DELETE POSITION</b></th>
                        ...
                        <tr>
                            ...
                            <td><button class="w3-button w3-blue w3-round-large" name="btnView" value="<%= rs.getString("position_id") %>">EDIT</button></td>
                            <td><button class="btn" type="submit" name="btnDelete" value="<%= rs.getString("position_id") %>"><i class="fa fa-trash"  ></i></button></td>
                        </tr>
