    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <header class="w3-container" style="padding-top:22px">
                <h5><b><i class="fa fa-dashboard"></i> View Salary </b></h5>
            </header>

            <div class="container">
                <br/>
                <br/>
                <p><button onclick="location.href='AddSalary'" class="w3-button w3-red w3-round-XLarge"> + ADD RECORD SALARY </button>
                </p>
                ...
                <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names..">
                    ...
                    <%
                     String driver = "org.apache.derby.jdbc.ClientDriver";
                                 ...
                                 String query = "SELECT * FROM EMPLOYEE , SALARY WHERE EMPLOYEE.EMP_ID = SALARY.EMP_ID";
                    ...
                    while (rs.next()) {%>
                      ...
                      <tr>
                        ...
                        <td><%= rs.getString("EMP_SALARY_MONTH") %></td>
