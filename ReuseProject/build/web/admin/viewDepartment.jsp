    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="container">
                ...
                <p><button onclick="location.href='AddDepartment'" class="w3-button w3-red w3-round-XLarge"> + ADD RECORD </button>
                </p>
                
                <form method="POST" action="ViewDepartmentController" style="border:5px solid #ccc">
                    ...
                    <table class="w3-table-all" align-text="center">
                        

                        <tr>
                            <th><b>DEPARTMENT ID</b></th>
                            <th><b>DEPARTMENT NAME</b></th>
                            <th><b>EDIT DEPARTMENT</b></th>
                            <th><b>DELETE DEPARTMENT</b></th>
                        ...
                        <tr>
                            ...
                            <td><button class="w3-button w3-blue w3-round-large" name="btnView" value="<%= rs.getString("dep_id") %>">EDIT</button></td>
                            <td><button class="btn" type="submit" name="btnDelete" value="<%= rs.getString("dep_id") %>"><i class="fa fa-trash"  ></i></button></td>
                        </tr>
