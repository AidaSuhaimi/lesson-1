...
<html>
    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="container">
                <form method="POST" action="AddPositionController" style="border:5px solid #ccc">
                    ...
                    <table align="center">
                        ...
                        <tr><td><b>Position ID</b></td>
                            <td>:</td>
                            <td><input type="text" name="positionID" value="" required autocomplete="off"></td>
                        </tr>
                        
                        <tr><td><b>Position Name</b></td>
                            <td>:</td>
                            <td><input type="text" name="positionName" value="" required autocomplete="off"></td>
                        </tr>
                    ...
                    <p></p>
                    <center>
                        <button type="submit" class="w3-btn w3-black">Add</button>
