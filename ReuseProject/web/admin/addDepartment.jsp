...
<html>
    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="container">
                <form method="POST" action="AddDepartmentController" style="border:5px solid #ccc">
                    ...
                    <table align="center">
                        ...
                        <tr><td><b>Department ID</b></td>
                            <td>:</td>
                            <td><input type="text" name="deptID" value="" required autocomplete="off"></td>
                        </tr>
                        
                        <tr><td><b>Department Name</b></td>
                            <td>:</td>
                            <td><input type="text" name="deptName" value="" required autocomplete="off"></td>
                        </tr>
