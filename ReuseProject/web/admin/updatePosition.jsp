...
<html>
    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="container">
                <form method="POST" action="UpdatePositionController" style="border:5px solid #ccc">
                    
                    <%
                            String driver = "org.apache.derby.jdbc.ClientDriver";
                            String connectionString = "jdbc:derby://localhost:1527/Administrator";
                            Integer positionID = (Integer)session.getAttribute("positionID");
                 ...
                 // create the java statement
                    ...
                    <table align="center">
                        ...
                        <tr><td><b>Position ID</b></td>
                            <td>:</td>
                            <td><input type="text" name="positionID" value="<%=rs.getString("position_id")%>" required autocomplete="off" readonly></td>
                        </tr>
                        
                        <tr><td><b>Position Name</b></td>
                            <td>:</td>
                            <td><input type="text" name="positionName" value="<%=rs.getString("position_name")%>" required autocomplete="off"></td>
                        </tr>
