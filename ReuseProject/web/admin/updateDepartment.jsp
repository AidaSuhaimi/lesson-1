    ...
    <body class="w3-light-grey">
        ...
        <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block">
                ...
                <a href="EditProfile" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bell fa-fw"></i>  Edit Profile</a>
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="container">
                <form method="POST" action="UpdateDepartmentController" style="border:5px solid #ccc">
                    
                    <%
                            String driver = "org.apache.derby.jdbc.ClientDriver";
                            String connectionString = "jdbc:derby://localhost:1527/Administrator";
                            Integer dep_ID = (Integer)session.getAttribute("dep_ID");
                             ...
                             String query = "SELECT * FROM DEPARTMENT WHERE DEP_ID =" + dep_ID + "";
...
s
                        <tr><td><b>Department ID</b></td>
                            <td>:</td>
                            <td><input type="text" name="deptID" value="<%=rs.getString("dep_id")%>" required autocomplete="off" readonly></td>
                        </tr>
                        
                        <tr><td><b>Department Name</b></td>
                            <td>:</td>
                            <td><input type="text" name="deptName" value="<%=rs.getString("dep_name")%>" required autocomplete="off"></td>
                        </tr>
